...
export async function createProjectAction(formData: FormData) {
  ...
  const [project] = await database
    ...
    .values({
      ...
      buildVisibility: str(formData, "buildVisibility") || "unknown",
      researchPriority: str(formData, "researchPriority") || "medium",
      researchQuestion: optStr(formData, "researchQuestion"),
      whatWouldChangeThesis: optStr(formData, "whatWouldChangeThesis"),
      adoptionConfidence: optInt(formData, "adoptionConfidence") ?? 0,
      activityOrigin: str(formData, "activityOrigin") || "unknown",
